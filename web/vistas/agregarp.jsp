<%-- 
    Document   : agregarp
    Created on : 03/12/2022, 12:05:19 AM
    Author     : JOSÉ
--%>
...
<head>
        ...
        <title>Agregar item de perros</title>
    </head>
     <body>
        ...
        <div class="container col-lg-3"> 
            <form action="Controladorp">
                <div class="form-group text-center"> 
                    ...
                    <h1> <strong> Agregar item productos perros</strong></h1>
                </div>               
                <div class="form-group">
                    <label> ID producto: </label> 
                    <input class="form-control" type="number" min="2" max="200" name="id" placeholder="Ingrese id producto">
                </div> 
                <div class="form-group">
